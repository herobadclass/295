...
char buf[1024];
char names[N][NAMELENGTH] = {{"Velia"},{"Katia"},{"Lyndon"},{"Salley"},{"Quentin"},{"Toni"},{"Pok"},{"Kenton"},{"Adelia"},{"les"},{"Reggie"},{"Francene"},{"Abel"},{"Treva"},{"Bert"},{"Nila"},{"Dayle"},{"Tonie"},{"Camelia"},{"Elana"},{"Vergie"},{"Christel"},{"Kirby"},{"Leonardo"},{"Tangela"},{"Sharonda"},{"Liza"},{"Liziana"},{"Cassidy"},{"Manda"}};
float grades[N] = {73.41,40.68,79.44,50.56,70.93,63.15,69.08,44.53,93.70,83.53,57.87,45.29,56.46,68.39,73.53,70.03,90.78,49.17,87.11,89.24,49.63,56.79,85.70,52.22,44.06,56.07,85.70,52.22,44.06,56.07};
int ranks[N];
float avg;
float passing_avg;
int num_passed;
